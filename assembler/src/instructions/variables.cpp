...
//    Signature::_call = { "call", OP_CALL, true, false, { { ArgumentType::Address } }, false, nullptr },
    ...
    Signature::_jal = { "jal", OP_JAL, true, false, { { ArgumentType::Value }, reg_val }, false,  nullptr, transform::transform_jal },
...
//    Signature::_ret = { "ret", OP_RET, true, false, { { } }, false, nullptr, nullptr },
  ...
  std::vector<Signature> signature_list = {
    ...
    Signature::_loadu,
    { "loadi", 0x00, true, false, { { ArgumentType::Register, ArgumentType::Immediate } }, true, nullptr, transform::load_immediate },
    Signature::_load,
    Signature::_mod,
    Signature::_mul,
    Signature::_nop,
