...
//    Signature::_call = { "call", inst::_call, true, false, { { ArgumentType::Address } }, false, nullptr },
      Signature::_cmp = {"cmp", inst::_compare, true, true, {reg_val, reg_reg_val}, false, nullptr,
                     transform::transform_reg_reg_val},
      ...
      Signature::_sext = {"sext", inst::_sext, true, false,
                          {{ArgumentType::Register, ArgumentType::Value, ArgumentType::Immediate}}, false, nullptr,
                          transform::transform_last_imm_to_byte},
      ...
      Signature::_xor = {"xor", inst::_xor, true, false, {reg_val, reg_reg_val}, false, nullptr,
                         transform::transform_reg_reg_val},
      Signature::_zext = {"zext", inst::_zext, true, false,
                          {{ArgumentType::Register, ArgumentType::Value, ArgumentType::Immediate}}, false, nullptr,
                          transform::transform_last_imm_to_byte};
