...
namespace lang::type {
  ...
  public:
    ...
    /** @brief Always 0: unit values occupy no storage. */
    size_t size() const override { return 0; }

    /** @brief Return the label representation of this type, "unit". */
    ...
    /** @brief Always false: unit values carry no data to reference. */
