...
#include "language/src/compiler/CompiledProgram.hpp"
...
namespace language {
  class Program {
    ...
    /** Compile Program. Return pointer to compiled program. */
    [[nodiscard]] CompiledProgram *compile(message::List &messages);
