...
namespace language::lexer {
  class Lexer {
    ...
    /** Get raw index into string. */
    [[nodiscard]] int index() const {
      return m_pos;
    }

    /** Get pointer to inner string. */
    ...
    void
    generate_bracket_mismatch_error(lexer::Token &open_bracket, lexer::Token &closing_bracket, message::List &list);
