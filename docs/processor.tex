...
\begin{document}
    ...
    \begin{tabular}{|c|c|c|l|}
        ...
        \hline
        N/A & \texttt{0000} & N/A & Skip test. \\
        \hline
        z & \texttt{1000} & \(= 0\) & Test of zero flag is set. \\
        \hline
        eq & \texttt{1010} & \(=\) & Test of equal. \\
        lt & \texttt{1001} & \(<\) & Test if less than. \\
        gt & \texttt{1011} & \(>\) & Test of greater than. \\
        \hline
    \end{tabular}

    Conditions are inverted by flipping the third bit.
    For example, \texttt{1110} means not equal, \(\neq\).
...
%    \end{center}
    ...
    Optionally, each read arguments from general-purpose registers \texttt{\$r15} onward.
