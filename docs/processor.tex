...
$ ./processor <input_file> [flags]
    ...
    There are no flags to control debugging.
    Rather, the debugging level is controlled by the \texttt{DEBUG} macro in \texttt{src/debug.h}, forming a bitmask of possible debug fields.
    This file may be modified and the application re-compiled for debugging changes to take effect.
\end{document}
